...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleId = __webpack_require__(256);

	var _ArticleId2 = _interopRequireDefault(_ArticleId);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tool = __webpack_require__(252);

	var _Tool2 = _interopRequireDefault(_Tool);

	var _GetNext = __webpack_require__(253);

	var _GetNext2 = _interopRequireDefault(_GetNext);
	    ...
	    function Index(props) {
	        ...
	        */
	        _this.DOMLoad = function (props) {
	            ...
	            _this.newGetNext = new _GetNext2.default(_this.refs.dataload, {
	                ...
	                load: function load(data) {
	                    ...
	                    classid.loadState = 2;
	                    if (_this.classid === _config2.default.indexClassId) {
	                        classid.title = _config2.default.indexTitle;
	                    } else {
	...
	*/
	...
	var ArticleList = exports.ArticleList = function (_Component2) {
	    ...
	    function ArticleList() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ArticleList).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                this.props.list.map(function (item, index) {
	                    ...
	                    var book_content = item.book_content;
	                    ...
	                    return _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'bottom', 'data-flex': 'main:justify' },
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'click' },
	                                '阅读：',
...
/***/ function(module, exports) {
	...
	exports.default = function (_ID) {
	    ...
	    /*
	        开始加载数据
	    */
	    action.GET_DATA_START = function (state) {
	        return { _ID: _ID, state: state, type: 'GET_DATA_START' };
	    };
	    /*
	        获取最新数据成功
	    */
	    action.GET_DATA_SUCCESS = function (state) {
	        return { _ID: _ID, state: state, type: 'GET_DATA_SUCCESS' };
	    };

	    /*
	        获取最新数据失败
	    */
	    action.GET_DATA_ERROR = function (state) {
	        return { _ID: _ID, state: state, type: 'GET_DATA_ERROR' };
	    };
	    ...
	    */
	    action.SETSCROLL = function (state) {
	        return { _ID: _ID, state: state, type: 'SETSCROLL' };
	    };

	    /*
	        更新classid
	    */
	    action.CLASSID_UPDATE = function (state) {
	        return { _ID: _ID, state: state, type: 'CLASSID_UPDATE' };
	    };
	...
	var Header = exports.Header = function (_Component) {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            ...
	            var leftTo = _props.leftTo;
	            var leftIcon = _props.leftIcon;
	            var rightTo = _props.rightTo;
	...
	var Loading = exports.Loading = function (_Component2) {
	    ...
	    _createClass(Loading, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'data-load data-load-' + this.props.loadState },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'msg' },
	                    this.props.loadMsg
...
/***/ function(module, exports) {
	...
	*/
	...
	/*
	    判断对象是不是Json
	*/
	Tool.isJson = function (obj) {
	    return (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) == 'object' && Object.prototype.toString.call(obj).toLowerCase() === '[object object]' && !obj.length; //true 是 false不是
	};

	/*
	    判断对象是不是数组
	*/
	Tool.isArray = function (arr) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (GetNext) {
	    if ("function" === 'function' && _typeof(__webpack_require__(254)) === 'object' && __webpack_require__(254)) {

	        !(__WEBPACK_AMD_DEFINE_FACTORY__ = (GetNext), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    ...
	    function getEl(select) {
	        switch (typeof select === 'undefined' ? 'undefined' : _typeof(select)) {
	            case 'string':
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var ArticleId = function (_Component) {
	    _inherits(ArticleId, _Component);

	    function ArticleId(props) {
	        _classCallCheck(this, ArticleId);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ArticleId).call(this, props));
	    ...
	    _createClass(ArticleId, [{
	        key: 'render',
	        value: function render() {
	            var main = null;
	            var _state = this.state;
	            var loadState = _state.loadState;
	            var loadMsg = _state.loadMsg;
	            ...
	            switch (loadState) {
	                ...
	                case 2:
	                    main = _react2.default.createElement(View, data);
	                    break;
	            }
	        ...
	        value: function componentDidMount() {
	            ...
	            this.ajax = _Tool2.default.get('/article/view.aspx', {
	                output: 'json',
	...
	var View = function (_Component2) {
	    _inherits(View, _Component2);
	    ...
	    _createClass(View, [{
	        ...
	        value: function render() {
	            var _props = this.props;
	            var book_title = _props.book_title;
	            var book_content = _props.book_content;
	            var book_click = _props.book_click;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('article', { dangerouslySetInnerHTML: { __html: book_content } })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	    ...
	    function Menu(props) {
	        ...
	        */
	        _this.DOMLoad = function (props) {
	            ...
	            if (DB.loadState !== 2) {
	                _this.ajax = _Tool2.default.get('/wapindex.aspx', { output: 'json', classid: _config2.default.indexClassId }, GET_DATA_SUCCESS, GET_DATA_ERROR);
	            }
	        };
	    ...
	    _createClass(Menu, [{
	        ...
	        value: function render() {
	            ...
	            switch (loadState) {
	                ...
	                case 2:
	                    main = _react2.default.createElement(MenuList, { list: data });
	                    break;
	            }
	            return _react2.default.createElement(
	                'div',
	...
	var MenuList = function (_Component2) {
	    _inherits(MenuList, _Component2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _erweima = __webpack_require__(259);
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'pictrue' },
	                            _react2.default.createElement('img', { src: _erweima2.default })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: 'https://github.com/1340641314/react-kelink', target: '_blank' },
	                            '134064134'
	                        )
	                    )
	                )
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*
	    分类最新列表数据
	*/
	var classNewList = function classNewList() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { def: start, classid: {} } : arguments[0];
	    var action = arguments[1];
	    ...
	    */
	    ...
	    switch (action.type) {
	        case 'GET_DATA_START':
	            //开始加载
	            return _Tool2.default.merged(state, action.state);
	        ...
	        case 'CLASSID_UPDATE':
	            ...
	            return _Tool2.default.merged(state, action.state);
	        default:
	            return _Tool2.default.merged(state, {
	                _ID: 'classNewList',
	                def: {
	                    page: 1,
	                    getNextBtn: true
	...
	/*
	    分类导航
	*/
	var classMenuList = function classMenuList() {
	    ...
	    */
	    ...
	    switch (action.type) {
	        case 'GET_DATA_SUCCESS':
	            //加载成功
	            return _Tool2.default.merged(state, { loadMsg: '加载完成了', data: action.state, loadState: 2 });
	        case 'GET_DATA_ERROR':
	            //加载失败
	            return _Tool2.default.merged(state, { loadMsg: '加载失败', title: '加载失败', loadState: 1 });
	        case 'SETSCROLL':
	            //记录滚动条
	            return _Tool2.default.merged(state, { scrollX: window.scrollX, scrollY: window.scrollY });
	        default:
	            return _Tool2.default.merged(state, { _ID: 'classMenuList' });
	    }
	};

	//导出方法
	exports.default = { classNewList: classNewList, classMenuList: classMenuList };
